...
const Pagination = ({ className, ...props }: React.ComponentProps<"nav">) => (
  <nav
    ...
    className={cn("tailwind.config.jsmx-auto tailwind.config.jsflex tailwind.config.jsw-full tailwind.config.jsjustify-center", className)}
    {...props}
  />
)
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    className={cn("tailwind.config.jsflex tailwind.config.jsflex-row tailwind.config.jsitems-center tailwind.config.jsgap-1", className)}
    {...props}
  />
))
...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    {...props}
  >
    <ChevronLeft className="tailwind.config.jsh-4 tailwind.config.jsw-4" />
    <span>Previous</span>
  </PaginationLink>
)
...
const PaginationNext = ({
  ...
  >
    <span>Next</span>
    <ChevronRight className="tailwind.config.jsh-4 tailwind.config.jsw-4" />
  </PaginationLink>
)
